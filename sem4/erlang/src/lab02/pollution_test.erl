...
get_daily_average_count_test() ->
  ...
  ?assertMatch(2/3, pollution:get_daily_average_data_count({2023,3,27}, M2)),
  ?assertMatch(2.0, pollution:get_daily_average_data_count({2023,3,27}, M6)),
  ?assertMatch(2/3, pollution:get_daily_average_data_count({2023,3,28}, M9)).
...
get_daily_average_count_fail_test() ->
  M = pollution:add_station("Stacja 2", {2,2}, pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor())),
  ?assertMatch({error, _}, pollution:get_daily_average_data_count({2023,3,27}, M)),
  M1 = pollution:add_value("Stacja 1", {{2023,3,28},{11,16,10}}, "PM10", 10, M),
  M2 = pollution:add_value("Stacja 2", {{2023,3,28},{11,16,11}}, "PM10", 20, M1),

  ?assertMatch({error, _}, pollution:get_daily_average_data_count({2023,3,27}, M2)),
  ?assertMatch({error, _}, pollution:get_daily_average_data_count({2023,3,29}, M2)).
